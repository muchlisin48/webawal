...
<body>
    <nav class="navbar navbar-expand-lg py-4 navigation header-padding " id="navbar">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse text-center" id="navbarsExample09">
                ...
                <a href="logout.php" class="btn btn-outline-danger d-none d-lg-block">Logout <i class="fa fa-angle-right ml-2"></i></a>
            </div>
        </div>
    </nav>
    <!--akhir navbar -->
        ...
        <div class="container">
            <div class="row">
                ...
                <form action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="GET">
                    ...
                    <input type="submit" value="Pilih" class="btn btn-outline-success">
                    <a href="chard.php">Refresh</a>
                </form>
    ...
    <div class="mx-auto">        
        <form class="d-flex">
            <a href="export.php"><button type="button" class="btn btn-outline-dark">Export</button></a>
            <a href="data.php"><button type="button" class="btn btn-outline-success">Tambah Data</button></a>
        </form>
